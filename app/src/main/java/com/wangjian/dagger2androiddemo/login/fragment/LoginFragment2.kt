package com.wangjian.dagger2androiddemo.login.fragment
...
class LoginFragment2 : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("TAG","LoginFragment2 onCreate()")
        arguments?.let {
    ...
    override fun onCreateView(
        ...
        Log.d("TAG","LoginFragment2 onCreateView()")
        return inflater.inflate(R.layout.fragment_login2, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        Log.d("TAG","LoginFragment2 onViewCreated()")
    }

    override fun onResume() {
        super.onResume()
        Log.d("TAG","LoginFragment2 onResume()")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d("TAG","LoginFragment2 onDestroy()")
    }

    override fun onDestroyView() {
        super.onDestroyView()
        Log.d("TAG","LoginFragment2 onDestroyView()")
    }
