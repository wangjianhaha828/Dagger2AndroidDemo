...
class LoginFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("TAG","LoginFragment1 onCreateView()")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("TAG","LoginFragment1 onViewCreated()")
    }

    override fun onResume() {
        super.onResume()
        Log.d("TAG","LoginFragment1 onResume()")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d("TAG","LoginFragment1 onDestroy()")
    }

    override fun onDestroyView() {
        super.onDestroyView()
        Log.d("TAG","LoginFragment1 onDestroyView()")
    }
    companion object {
        /**
